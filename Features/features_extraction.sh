...
/Users/Marine/Downloads/openSMILE-2.1.0/inst/bin/SMILExtract  -C /Users/Marine/Downloads/openSMILE-2.1.0/myconfig/Speaker_recognition.conf  -I ${path_wav}  -O ${path_csv}/Speaker_trait/results.csv